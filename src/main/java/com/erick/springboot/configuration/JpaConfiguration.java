package com.erick.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.erick.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.erick.springboot.model" });
