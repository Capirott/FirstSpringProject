...
import com.erick.springboot.service.ProductService;
...
public class ProductController {
	...
	public ResponseEntity<?> getProduct(@PathVariable("id") long id) {
		...
		if (product == null) {
			...
			return new ResponseEntity<Object>(new CustomErrorType("Product with id " + id 
	...
	public ResponseEntity<?> createProduct(@RequestBody Product product, UriComponentsBuilder ucBuilder) {
		...
		if (productService.isProductExist(product)) {
			...
			return new ResponseEntity<Object>(new CustomErrorType("Unable to create. A Product with name " + 
	...
	public ResponseEntity<?> updateProduct(@PathVariable("id") long id, @RequestBody Product product) {
		...
		if (currentProduct == null) {
			...
			return new ResponseEntity<Object>(new CustomErrorType("Unable to upate. Product with id " + id + " not found."),
	...
	public ResponseEntity<?> deleteProduct(@PathVariable("id") long id) {
		...
		if (product == null) {
			...
			return new ResponseEntity<Object>(new CustomErrorType("Unable to delete. Product with id " + id + " not found."),
					HttpStatus.NOT_FOUND);
		}
