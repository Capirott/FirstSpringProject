...
import com.erick.springboot.service.CustomerService;
...
public class CustomerController {
	...
	public ResponseEntity<?> getCustomer(@PathVariable("id") long id) {
		...
		if (customer == null) {
			...
			return new ResponseEntity<Object>(new CustomErrorType("Customer with id " + id 
	...
	public ResponseEntity<?> updateCustomer(@PathVariable("id") long id, @RequestBody Customer customer) {
		...
		if (currentCustomer == null) {
			...
			return new ResponseEntity<Object>(new CustomErrorType("Unable to upate. Customer with id " + id + " not found."),
	...
	public ResponseEntity<?> deleteCustomer(@PathVariable("id") long id) {
		...
		if (customer == null) {
			...
			return new ResponseEntity<Object>(new CustomErrorType("Unable to delete. Customer with id " + id + " not found."),
					HttpStatus.NOT_FOUND);
		}
